...
export  function Carousel({ games }: {games:Games[]}) {
  ...
  <Card
    ...
    >
      ...
      <CardBody className="flex justify-between items-center flex-row relative z-10 min-h-[500px]">
        <Button
          variant="ghost"
          color="primary"
          isIconOnly
      ...
      <CardFooter  className="bg-black/20 p-5  text-white items-start flex flex-col z-10 transition-all  " style={{opacity:hovered?'1':'0',transition:'all 0.3s ease'}}>
        ...
        <p className="hidden md:block md:w-1/2 max-w-3xl text-lg md:text-xl leading-relaxed text-gray-200 drop-shadow-[0_0_8px_rgba(0,0,0,0.8)]">
